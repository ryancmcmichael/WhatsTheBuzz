...
<head>
<meta charset="utf-8">
<title><?php echo TITLE;?>: Subscribe</title>
...
<link rel="shortcut icon" href="<?php echo HOST;?>/favicon.ico">
  ...
  <body>
	...
	<h2 class='subReq'>Subscription Request</h2>
	...
	<div id="Error" class="message error" style="display:none;"><h3>Woops! Something went wrong. We'll check it out. In the meantime, please email <a href='mailto:subscribe@whatsthe.buzz'>subscribe@whatsthe.buzz</a></h3></div>
	 ...
	 <form role="form" id="profile">
			...
			<label class='subLabel'>Please tell us your name</label>
			<div class="row">
			...
			<label class='subLabel'>Email and Phone</label>
			<!-- Email and Phone -->
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-md-6">
					<div class="form-group">
				...
				<div class="col-sm-2">
					<div class="form-group">
						<input type="tel" name="telepre" id="telepre" class="form-control input-lg" placeholder="area" tabindex="4" width="3">
					</div>
				</div><!-- end section -->
					<div class="col-sm-4">
						<div class="form-group">
							<input type="tel" name="telefull" id="telefull" class="form-control input-lg" placeholder="phone" tabindex="4">
						</div>
					</div>
			</div><!-- end row -->
			<label class='subLabel'>What is the name of your business?</label>
			
			<div class="row"><!-- business name -->
			
			<div class="col-sm-12">
					<div class="form-group">
						<input type="text" name="bizname" id="bizname" class="form-control input-lg" placeholder="Name of your business" tabindex="5">
					</div>
				</div><!-- end section -->
			
			</div>	
			<label class='subLabel'>How many locations would you like to support?</label>
			<div class="row">
			
			<div class="col-sm-2">
					<div class="form-group">
						<input type="text" name="numloc" id="numloc" class="form-control input-lg" placeholder="1" tabindex="6">
					</div>
				</div><!-- end section -->
			...
			<div class="row" style='text-align:center;'>
				<div style='display:inline-block;'><button class="btn btn-lg btn-info buzzButton" id="subscribeHere" style="margin-left:50px;" role="button">Let's Go!</button></div>		
