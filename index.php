 ...
 */
	...
	//echo SRVHOST;
/*
 *	FOLLOWING ARE SPECIFIC TO OUR SITE - JBP
 */	
 	switch(SRVHOST)
	{
		case "whatsthebuzz":
	...
	define('TITLE','WhatsThe.Buzz');
	define('HOST', $myHTTP . $_SERVER['HTTP_HOST']."/");
	define('COPY', "<span style='font-size:.9em;color:#aaa;'>Ohm Interactive Copyright &copy; ".date("Y")."</span>");
	define('MONTHLY_PLAN', "15.00");		// 
	define('QUARTERLY_PLAN', "40.50");
	define('ANNUAL_PLAN',"135.00");
	define('DBHOST','LOCALHOST');
	define('DBNAME','SURVEY');
	define('DBPASS','demo');
	define('DBUSR','root');
	define('YE','YO');
	
	//echo HOST . " my http " . $myHTTP;;
/*
 *---------------------------------------------------------------
 * ERROR REPORTING
 *---------------------------------------------------------------
